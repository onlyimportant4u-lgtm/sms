...
Previously, when a user or a command line tool (let's call it a "client")
needed to make a request of setuptools to take a certain action, for
example, generating a list of installation requirements, the client would
would call "setup.py egg_info" or "setup.py bdist_wheel" on the command line.

PEP 517 defines a different method of interfacing with setuptools. Rather
than calling "setup.py" directly, the client should:
...
def no_install_setup_requires():
    ...
    Under PEP 517, the backend reports build dependencies to the client,
    and the client is responsible for ensuring they're installed.
...
class _BuildMetaLegacyBackend(_BuildMetaBackend):
    ...
    def run_setup(self, setup_script='setup.py'):
        ...
        try:
            ...
            # While PEP 517 clients should be calling each hook in a fresh
